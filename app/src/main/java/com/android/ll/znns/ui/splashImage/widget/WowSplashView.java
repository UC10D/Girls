package com.android.ll.znns.ui.splashImage.widget;
...
import com.android.ll.znns.ui.splashImage.support.SvgPathParser;
...
public class WowSplashView extends View {
  ...
  public WowSplashView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    mTowerPath = new SvgPathParser().parsePath(context.getResources().getString(R.string.splash));
